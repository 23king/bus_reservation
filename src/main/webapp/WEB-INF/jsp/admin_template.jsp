                    ...
                    <div class="seat">
                        <table style="border:#a7a7a7 solid 0px;cellpadding:0;cellspacing:0;">
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td class="td_2">
                                    <div class="seat_1" onclick="setSeat41(1, this.id, false, this);" id="4">4</div>
                                </td>
                                <td>
                                    <div class="seat_1" onclick="setSeat41(1, this.id, false, this);" id="8">8</div>
                                </td>
                                <td>
                                    <div class="seat_1" onclick="setSeat41(1, this.id, true, this);" id="12">12</div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="seat_1" onclick="setSeat41(1, this.id, false, this);" id="24">24</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="seat_1" onclick="setSeat41(1, this.id, true, this);" id="11">11</div>
                                </td>
                                <td>
                                    <div class="seat_1" onclick="setSeat41(1, this.id, false, this);" id="15">15</div>
                                </td>
                                <td>
                                    <div class="seat_1" onclick="setSeat41(1, this.id, false, this);" id="19">19</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="seat_1" onclick="setSeat41(1, this.id, true, this);" id="10">10</div>
                                </td>
                                <td>
                                    <div class="seat_1" onclick="setSeat41(1, this.id, false, this);" id="14">14</div>
                                </td>
                                <td>
                                    <div class="seat_1" onclick="setSeat41(1, this.id, false, this);" id="18">18</div>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="seat_1" onclick="setSeat41(1, this.id, true, this);" id="9">9</div>
                                </td>
                                <td>
...
<script>
    ...
    function setSeat41(busNum, seatNum, multiFlag) {
        ...
        if(seatEl.className === "seat_1") {
            ...
            emptyList.push(parseInt(seatNum));
        } else if(seatEl.className === "seat_2") {
            var seatNum2 = (seatNum % 2 == 0)?parseInt(seatNum)-1 : parseInt(seatNum)+1;

            seatEl.className = "seat_1";
            document.getElementById(seatNum2).className = "seat_1";

            multiList.splice(multiList.indexOf(parseInt(seatNum)),1);
            multiList.splice(multiList.indexOf(parseInt(seatNum2)),1);
            ...
            multiList.push(parseInt(seatNum));
            multiList.push(parseInt(seatNum2));

            emptyList.splice(emptyList.indexOf(parseInt(seatNum)),1);
            if(emptyList.indexOf(parseInt(seatNum2))>-1) {
                emptyList.splice(emptyList.indexOf(parseInt(seatNum2)),1);
            }
        }
